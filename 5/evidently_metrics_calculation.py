...
def calculate_metrics_postgresql(curr, i):
	...
	trip_std = result['metrics'][4]['result']['current_characteristics']['std']
	...
	curr.execute(
		...
		(begin + datetime.timedelta(i), prediction_drift, num_drifted_columns, share_missing_values, quantile_0_5, trip_std)
	)
